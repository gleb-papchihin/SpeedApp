...
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeCreateNetFromFile(JNIEnv *env,
                                                                                 jclass type,
                                                                                 jstring modelName_) {
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeReleaseNet(JNIEnv *env, jclass type,
                                                                          jlong netPtr) {
    if (0 == netPtr) {
        return 0;
    }
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeCreateSession(
...
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeReleaseSession(JNIEnv *env,
                                                                              jclass type,
                                                                              jlong netPtr,
                                                                              jlong sessionPtr) {
...
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeRunSession(JNIEnv *env, jclass type,
                                                                          jlong netPtr,
                                                                          jlong sessionPtr) {
    auto net = (MNN::Interpreter *) netPtr;
    auto session = (MNN::Session *) sessionPtr;
...
extern "C" JNIEXPORT jint JNICALL
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeRunSessionWithCallback(
...
extern "C" JNIEXPORT jint JNICALL
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeReshapeSession(JNIEnv *env,
                                                                              jclass type,
                                                                              jlong netPtr,
                                                                              jlong sessionPtr) {
    auto net = (MNN::Interpreter *) netPtr;
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeGetSessionInput(
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeGetSessionOutput(
        JNIEnv *env, jclass type, jlong netPtr, jlong sessionPtr, jstring name_) {
    auto net = (MNN::Interpreter *) netPtr;
    auto session = (MNN::Session *) sessionPtr;
    if (nullptr == name_) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeReshapeTensor(JNIEnv *env,
                                                                             jclass type,
                                                                             jlong netPtr,
                                                                             jlong tensorPtr,
                                                                             jintArray dims_) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeSetInputIntData(
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeSetInputFloatData(
...
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeTensorGetDimensions(JNIEnv *env,
                                                                                   jclass type,
                                                                                   jlong tensorPtr) {
    auto tensor = (MNN::Tensor *) tensorPtr;
...
extern "C" JNIEXPORT jint JNICALL
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeTensorGetUINT8Data(JNIEnv *env,
                                                                                  jclass type,
                                                                                  jlong tensorPtr,
                                                                                  jbyteArray jdest) {
    auto tensor = (MNN::Tensor *) tensorPtr;
...
extern "C" JNIEXPORT jint JNICALL
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeTensorGetIntData(JNIEnv *env,
                                                                                jclass type,
                                                                                jlong tensorPtr,
                                                                                jintArray dest) {
    auto tensor = (MNN::Tensor *) tensorPtr;
...
extern "C" JNIEXPORT jint JNICALL
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeTensorGetData(JNIEnv *env,
                                                                             jclass type,
                                                                             jlong tensorPtr,
                                                                             jfloatArray dest) {
...
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeConvertBufferToTensor(
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_example_mobileneuralnetwork_mnn_MNNNative_nativeConvertBitmapToTensor(
